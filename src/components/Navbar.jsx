            ...
            <Container>
                <div className='flex justify-between lg:gap-0 gap-2 items-center'>
                    ...
                    <div className="w-[50%] relative" >
                        <input value={searchFilterFaka} onKeyUp={handleKeySetUp}  onChange={handleSearch} type="search" className='w-full border-2  rounded-md outline-3 outline-cyan-200 py-2 lg:py-3 px-2 lg:text-[18px]  text-[16px]' placeholder='Search' /> <FaSearch onClick={handleSearchFilter} className='absolute lg:top-5 top-3 lg:right-8 right-2 text-[#262626] cursor-pointer' />
                    ...
                    <div className="lg:w[39%] w-[25%] relative flex justify-end lg:gap-6 gap-2">
                        ...
                        <div className='cursor-pointer lg:mr-0 mr-2 z-50' ref={shopRef}>
                            ...
                            <div className='absolute top-[-18px] right-[-15px]'>
                                <h2 className='h-6 w-6 rounded-full bg-[#154949f7] text-center text-[#ececec] font-bold text-[16px]'>{data.length}</h2>
                            </div>
                        </div>
                        {shopshow &&
                            data?.map((item, i) => (
                                <div key={i} className=' lg:w-[80%] w-[250px] bg-[#F5F5F3] rounded-b-md absolute z-50 top-[35px] lg:right-0 right-[5px] '>
                                    ...
                                    <div className=' hover:bg-[#ffff] rounded-b-md lg:py-6 py-2'>
                                        <h2 className='ml-5 font-dm font-bold lg:text-[16px] text-[12px] text-[#262626]'><span className='font-normal text-[#767676]'>Subtotal:</span> ${totalPrice}</h2>
