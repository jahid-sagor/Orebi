...
const PegiNumber = ({totalPage,perPage,paginate,next,prev,currentPage,catFilter}) => {
    //  pegination number calculation start========================================
    let pageNumber = []
    for(let i = 0; i < Math.ceil(catFilter.length > 0 ? catFilter :  totalPage / perPage); i++){
       pageNumber.push(i)
    }
    //  pegination number calculation end===========================================
  return (
    <>
      <nav aria-label="Page navigation example" className='text-center pt-10'>
